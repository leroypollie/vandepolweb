...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
	...
	<div class="blog-post">
		...
		<div class="entry-thumb">
				<a href="<?php esc_url( the_permalink() ); ?>" title="<?php esc_attr( the_title_attribute() ); ?>"><?php the_post_thumbnail('cloudworx-large-thumb'); ?></a>
		</div>
		
		<header class="entry-header">
			<?php the_title( sprintf( '<h2 class="title-post entry-title"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h2>' ); ?>
			<p class="meta-post"> <?php cloudworx_posted_on(); cloudworx_edit_link();?> </p>
		</header>

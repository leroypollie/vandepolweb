 ...
 * Set import files
 */
function cloudworx_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'cloudworx'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'cloudworx_set_import_files' );

/**
 * Define actions that happen after import
 */
function cloudworx_actions_after_import() {
	...
	update_option( 'blogname', 'Cloudworx' );
...
add_action( 'pt-ocdi/after_import', 'cloudworx_actions_after_import' );

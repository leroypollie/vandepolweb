...
function cloudworx_banner_background() {
	
	/* $title = get_theme_mod('banner_sub_title', __('Welcome to Cloudworx', 'cloudworx')); */
	$fornt_img = get_theme_mod('banner_side_img',get_stylesheet_directory_uri() . '/images/home_banner.png');
	$subtitle = get_theme_mod('banner_main_title', __('The Fundamental Cloud', 'cloudworx'));
	$subpera = get_theme_mod('banner_para', __('A type of computing that uses groups of servers and scalable resources!', 'cloudworx'));
	/* $button_text1 = get_theme_mod('banner_btn1_txt', __('Ready to start', 'cloudworx')); */
	$button_text2 = get_theme_mod('banner_btn2_txt', __('Create Account', 'cloudworx'));
	...
	<div class="header-background">
		<div class="header-content">
			<div class="container">
				...
				<div class="<?php if(!empty($fornt_img)){ echo 'col-md-12 col-lg-12' ;} else {echo 'col-md-12 col-lg-12';} ?> ">
...
function cloudworx_banner_video() {
